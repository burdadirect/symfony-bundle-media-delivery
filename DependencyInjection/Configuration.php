    ...
    $rootNode
      ->children()
        ...
        ->arrayNode('settings')->addDefaultsIfNotSet()
          ->children()
            ->variableNode('route')->defaultValue('imagecache')->end()
            ->variableNode('duration')->defaultValue('~1200')->info('Number of seconds to expose the image. Can be prefixed with "~" to support caching.')->end()
          ->end()
        ->end()
